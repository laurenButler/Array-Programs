//Lauren Butler ARRAY PROGRAM 2 Pd:2
   ...
   public class ArrayTwo
   {
      ...
      //instantiates scanner and array
         ...
         for( i = 0; i < values.length; i++)
         {
           ...
           for(int p = 0; p < (count/5); p++)
            {
             System.out.print("*");
            }
           
			  System.out.print("\n Between 11-20 is " + count2 + ": ");
           for(int b = 0; b < (count2/5); b++)
            {
             System.out.print("*");
            }
           
			  System.out.print("\n Between 21-30 is " + count3 + ": "); 
           for(int c = 0; c < (count3/5); c++)
            {
             System.out.print("*");
            }
            
			  System.out.print("\n Between 31-40 is " + count4 + ": ");
           for(int d = 0; d < (count4/5); d++)
            {
             System.out.print("*");
            }
           
			  System.out.print("\n Between 41-50 is " + count5 + ": "); 
           for(int e = 0; e < (count5/5); e++)
            {
             System.out.print("*");
            }
           
			  System.out.print("\n Between 51-60 is " + count6 + ": "); 
           for(int f = 0; f < (count6/5); f++)
            {
             System.out.print("*");
            }
           
			  System.out.print("\n Between 61-70 is " + count7 + ": "); 
           for(int g = 0; g < (count7/5); g++)
            {
             System.out.print("*");
            }
           
			  System.out.print("\n Between 71-80 is " + count8 + ": "); 
           for(int h = 0; h < (count8/5); h++)
            {
             System.out.print("*");
            }
           
			  System.out.print("\n Between 81-90 is " + count9 + ": "); 
           for(int j = 0; j < (count9/5); j++)
            {
             System.out.print("*");
            }
           
			  System.out.print("\n Between 91-100 is " + count2 + ": "); 
           for(int k = 0; k < (count10/5); k++)
            {
             System.out.print("*");
            }
